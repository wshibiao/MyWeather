...
//    FrameLayout frameWeather;
    ...
    @Bind(com.wshibiao.myweather.R.id.toolbar)
    Toolbar toolbar;
    @Bind(com.wshibiao.myweather.R.id.collapsing_toolbar_layout)
    CollapsingToolbarLayout collapsingToolbarLayout;
    @Bind(com.wshibiao.myweather.R.id.fab)
    FloatingActionButton fab;
    @Bind(com.wshibiao.myweather.R.id.drawer_layout)
    DrawerLayout drawerLayout;
//    @Bind(R.id.my_refresh)
//    SwipeRefreshLayout myRefresh;
    @Bind(com.wshibiao.myweather.R.id.nav_view)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wshibiao.myweather.R.layout.weather_deatil_activity);
...
//                        .setAction("Action", null).show();
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawerLayout, toolbar, com.wshibiao.myweather.R.string.navigation_drawer_open, com.wshibiao.myweather.R.string.navigation_drawer_close);
...
//        myRefresh.setOnRefreshListener(this);
       ...
       navView.setNavigationItemSelectedListener(this);
        ...
        WeatherDetailFragment weatherDetailFragment = (WeatherDetailFragment) getSupportFragmentManager().findFragmentById(com.wshibiao.myweather.R.id.frame);
        if (weatherDetailFragment == null) {
            // Create the fragment
            weatherDetailFragment = weatherDetailFragment.newInstance();
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), weatherDetailFragment, com.wshibiao.myweather.R.id.frame);
        }
...
//        processExtraData();
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),
                com.wshibiao.myweather.R.mipmap.city_day);
        // 创建Palette对象
...
//    }
    ...
    public void onBackPressed() {
        DrawerLayout drawer = (DrawerLayout) findViewById(com.wshibiao.myweather.R.id.drawer_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.wshibiao.myweather.R.menu.weather_deatil, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.wshibiao.myweather.R.id.action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == com.wshibiao.myweather.R.id.nav_choose_city) {
            startActivity(new Intent(WeatherDetailActivity.this, ChooseCityActivity.class),
                    ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
        } else if (id == com.wshibiao.myweather.R.id.nav_settings
                ) {
            startActivity(new Intent(WeatherDetailActivity.this, SettingsActivity.class));
        } else if (id == com.wshibiao.myweather.R.id.nav_share) {
